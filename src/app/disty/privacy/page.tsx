...
export default function PrivacyPolicy() {
  return (
    <div style={{ maxWidth: 800, margin: "40px auto", padding: 20 }}>
      ...
      <p>
        Disty respects your privacy. This app does not collect personally
      ...
      <p>
        ...
        and to improve the experience. This data cannot be used to
        identify you.
      </p>

      <h2>Third-Party Services</h2>
      <p>
        Disty may use third-party services such as analytics providers
      ...
      <p>
        Disty does not knowingly collect any personal information from
        children.
      </p>
      ...
      <p>
        ...
        at: <strong>constact@savaldev.com</strong>
      </p>
